    ...
    for (const record of records) {
        ...
        switch (payload['type']) {
            ...
            case 'agent_reasoning': {
                ...
                if (text.length > 0)
                    push({ kind: 'context', label: 'reasoning', text, time });
                break;
            }
...
export function codexAdapter(roots = codexRoots()) {
    return {
        id: 'codex',
